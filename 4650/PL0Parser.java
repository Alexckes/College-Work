...
class CUP$PL0Parser$actions {
  ...
  public final java_cup.runtime.Symbol CUP$PL0Parser$do_action_part00000000(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$PL0Parser$act_num)
		...
		RESULT = start_val;
          ...
          case 4: // constDecl ::= 
            {
              ...
              CUP$PL0Parser$result = parser.getSymbolFactory().newSymbol("constDecl",2, ((java_cup.runtime.Symbol)CUP$PL0Parser$stack.peek()), RESULT);
            }
          return CUP$PL0Parser$result;
          ...
          case 8: // varDecl ::= 
            {
              ...
              CUP$PL0Parser$result = parser.getSymbolFactory().newSymbol("varDecl",4, ((java_cup.runtime.Symbol)CUP$PL0Parser$stack.peek()), RESULT);
            }
          return CUP$PL0Parser$result;
          ...
          case 12: // procDecl ::= 
            {
              ...
              CUP$PL0Parser$result = parser.getSymbolFactory().newSymbol("procDecl",6, ((java_cup.runtime.Symbol)CUP$PL0Parser$stack.peek()), RESULT);
            }
          return CUP$PL0Parser$result;
          ...
          case 18: // statement ::= 
            {
              ...
              CUP$PL0Parser$result = parser.getSymbolFactory().newSymbol("statement",7, ((java_cup.runtime.Symbol)CUP$PL0Parser$stack.peek()), RESULT);
            }
          return CUP$PL0Parser$result;
          ...
          default:
            throw new Exception(
               "Invalid action number "+CUP$PL0Parser$act_num+"found in internal parse table");
  ...
  public final java_cup.runtime.Symbol CUP$PL0Parser$do_action(
    ...
    throws java.lang.Exception
    {
              return CUP$PL0Parser$do_action_part00000000(
                               CUP$PL0Parser$act_num,
                               CUP$PL0Parser$parser,
                               CUP$PL0Parser$stack,
                               CUP$PL0Parser$top);
    }
}
